...
class Account{
	...
	// changePw(String) :: 매개 변수 값으로 password 값 변경
	...
	public void changePw(String pw) {
		if(pw.length() < 5) {      // 에러메시지 출력
			...
			this.password =pw;// 멤버 변수를 pw로 수정
...
public class Ex_Account {
	public static void main(String[] args) {
		...
		Account user = new Account(num, id, password);	// String 매개변수가 3개가 있었던 위에 있는 생성자가 실행이 됨
