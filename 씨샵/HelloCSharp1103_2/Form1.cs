...
namespace HelloCSharp1103_2
{
    public partial class Form1 : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            label3.Text = "1부터 10까지의 짜수를 제곱한 것 \n";
            foreach(var item in output) 
        ...
        {
            // 익명 객체
            // select란, 배열이나 리스트에 있는 구성요소를 내가 원하는 형태로 출력함 
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            // 가격 내림차순 (비싼 순) 내림 차순은 descending을 꼭 써야 함
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            XElement xe = XElement.Load(url); // xml 형식으로 불러옴 (텍스트가 아니고 XML 데이터로 불러오겠다!)
            ...
            var xmlQuery2 = from item in xe.Descendants("data") // 타입이 달라서 변수 새로 생성함 
                            select new
                            {
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            ...
            weatherBindingSource.DataSource = list; // Binding : 묶다  weather이랑 묶었다!!! 
        }
    }
}
