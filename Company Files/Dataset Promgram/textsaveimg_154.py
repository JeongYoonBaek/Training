...
def extract_frames(video_path, output_dir):
    ...
    while success:
        frame_filename = os.path.join(output_dir, f"TS2_midnight_frame110_{count:04d}.jpg")
        try:
...
video_path = r'D:\\Crowd DataSet\\154.CCTV VIDEO\\01.Data\\1.Training\\Source Data\\TS2_ja-ma\\midnight(0~9)\\2021-08-05_08-24-00_thu_sunny_out_ja-ma_C0041.mp4'
frames_output_dir = r'D:\\Crowd DataSet\\midnight jpg'
json_file_path = r'D:\\Crowd DataSet\\154.CCTV VIDEO\\01.Data\\1.Training\\Label_1107_add\\TL2_ja-ma\\midnight(0~9)\\2021-08-05_08-24-00_thu_sunny_out_ja-ma_C0041.json'
output_directory = r'D:\\Crowd DataSet\\midnight label'
...
for frame_number in range(total_frames):
    ...
    # 텍스트 파일로 저장
    txt_file_path = os.path.join(output_directory, f'TS2_midnight_frame110_{frame_number:04d}.txt')  # 저장할 경로와 파일 이름 설정
