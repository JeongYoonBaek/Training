...
def extract_frames(video_path, output_dir, fps):
    ...
    while success:
        ...
        if frame_count % frame_interval == 0:
            # 4자리 패딩을 사용한 파일명 생성
            frame_filename = os.path.join(output_dir, f"175_frame_{saved_frame_count:04d}.jpg")
...
video_path = r'D:\\GwangAn Subway Video\\3FPS\\175.mp4'
frames_output_dir = r'D:\\GwangAn Subway Video\\3FPS\\image14'
