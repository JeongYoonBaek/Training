# 원본 동영상을 프레임 단위로 이미지를 추출 시키는 코드
import cv2
import os
...
def extract_frames(video_path, output_dir, fps):
    ...
    while success:
        ...
        if frame_count % frame_interval == 0:
            # 4자리 패딩을 사용한 파일명 생성
            frame_filename = os.path.join(output_dir, f"Parking-2_frame_{saved_frame_count:04d}.jpg")
...
video_path = r'C:\\Users\\kiot\\Downloads\\NAVER WORKS\\Parking System\\video\\20230731_091204.mp4'
frames_output_dir = r'C:\Users\kiot\Downloads\NAVER WORKS\Parking System\image'

# 출력 디렉토리가 없다면 
os.makedirs(frames_output_dir, exist_ok=True)

# 1초에 해당 FPS씩 비디오가 끝날 때까지 프레임을 추출
fps = 5  # 1초당 추출할 프레임 수
